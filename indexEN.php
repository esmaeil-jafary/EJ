...
?>
            ...
            <div class="container position-relative h-100 ts-align__vertical">
                <div class="row min-w-100">
                    <div class="col-md-8">
                        ...
                        <figure class="ts-social-icons mb-4">
                            ...
                            <a href="https://t.me/EJafary" class="mr-3">
                ...
                <a href="#my-services" class="ts-btn-effect position-absolute ts-bottom__0 ts-left__0 ts-scroll ml-3 mb-3">
                    <span class="ts-visible ts-circle__sm rounded-0 ts-bg-primary">
                        <i class="fa fa-arrow-down text-white align-middle"></i>
                    </span>
        ...
        <main id="ts-content">
                            ...
                            <div class="ts-item" data-animate="ts-fadeInUp">
                                <div class="ts-item-content">
                                    ...
                                    <div class="ts-item-body">
                                        <h4>طراحی وب</h4>
                                        <p class="mb-0">
                                        طراحی انواع وبسایت های فروشگاهی، شرکتی،خدماتی، شخصی 
                                        </p>
                                    </div>
                                    <!--end ts-item-body-->
                            ...
                            <div class="ts-item" data-animate="ts-fadeInUp" data-delay=".3s">
                                <div class="ts-item-content">
                                    ...
                                    <div class="ts-item-body">
                                        <h4>UI & UX</h4>
                                        <p class="mb-0">
                                    طراحی صفحات واکنش گرا با فریم ورک BOOTSTRAP
                                        </p>
                                    </div>
                                    <!--end ts-item-body-->
                                    <div class="ts-item-footer">
            ...
            <section id="about-me" class="ts-block pb-4">
                <div class="container">
                    ...
                    <div class="row ts-align__vertical">
                        ...
                        <div class="col-md-6">
                            <h4 class="ts-bubble-border">سلام</h4>
                            <p>
                            دانشجوی کارشناسی ارشد فناوری اطلاعات IT</br> 
                            طراحی انواع وبسایت با PHP </br>
                            طراح وبسایت با انواع CMS </br>
                            </p>
                            <dl class="ts-column-count-2">
                                <dt>نام:</dt>
                                <dd>اسماعیل جعفری</dd>
                                <dt>تلفن:</dt>
                                <dd><span class="ltr-text">+989396506246</span></dd>
                                <dt>ایمیل:</dt>
                               <dd><u>EJAFAARY@GMAIL.COM</u></dd>
                                <dt>تلگرام:</dt>
                                <dd><span class="ltr-text"><u>@EJafary</u></span></dd>
                            </dl>
                            <hr class="ts-hr-light mb-5">
                            <a href="#contact" class="ts-btn-effect mr-2">
                                <span class="ts-visible btn btn-primary ts-btn-arrow">با من تماس بگیرید</span>
                                <span class="ts-hidden btn btn-primary ts-btn-arrow" data-bg-color="#d44729">با من تماس بگیرید</span>
                            </a>
            ...
            <section class="ts-block">
                <div class="container">
                    <div class="text-center px-5 pt-5 position-relative">
                        ...
                        <a href="#contact" class="btn btn-primary mr-2 ts-push-down__50 ts-has-talk-arrow">ارتباط برای همکاری</a>
            ...
            <section id="my-skills" class="ts-block pb-5">
                <div class="container">
                    ...
                    <!--end ts-title-->
                    <h4>هر روز یک چالش جدید است</h4>
                    <div class="row">
                        <div class="col-md-6">
                            <p>
                                نیاز به شناخه شدن محصولات ، خدمات و توانایی های شما روز به روز بیشتر احساس می گردد، و پاسخگویی به این نیازها بجز ورود به دنیای وب میسر نمی گردد
                              </p>
                            <p>
                                با چندین سال تجربه در رمینه طراحی انواع وبسایت فروشگاهی، شرکتی و شخصی و طراحی انواع صفحات ریسپانسیو سایت همچنین بهینه سازی   CMSها در خدمت شما هستیم
                            </p>

                            <a href="#contact" class="btn btn-outline-light mb-5">با من تماس بگیرید</a>
                        </div>
                        <!--end col-md-6-->
                        <div class="col-md-6">
                            <div class="progress" data-progress-width="80%">
                                <h5 class="ts-progress-title">طراحی وب</h5>
                                <figure class="ts-progress-value"></figure>
                                <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <!--end progress-->
                            <div class="progress" data-progress-width="60%">
                                <h5 class="ts-progress-title">کدنویسی</h5>
                                <figure class="ts-progress-value"></figure>
                                <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <!--end progress-->
                            <div class="progress" data-progress-width="90%">
                                <h5 class="ts-progress-title">UI & UX</h5>
                                <figure class="ts-progress-value"></figure>
                                <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <!--end progress-->
                            <div class="progress" data-progress-width="100%">
                                <h5 class="ts-progress-title">تعهد</h5>
                                <figure class="ts-progress-value"></figure>
                                <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <!--end progress-->
            ...
            <section class="ts-block pb-5" id="portfolio">
                <div class="container">
                    ...
                    <div class="card-columns ts-gallery ts-column-count-4">
                        <a href="assets/img/EventIt.png" class="card ts-gallery__item popup-image" data-animate="ts-fadeInUp">
                            <div class="ts-gallery__item-description">
                                <h6 class="ts-opacity__50">وبسایت خبری</h6>
                                <h4>EVENTIT </h4>
                            </div>
                            <img src="assets/img/EventIt.png" class="card-img" alt="">
                        ...
                        <a href="assets/img/img-work-02.png" class="card ts-gallery__item popup-image" data-animate="ts-fadeInUp">
                            <div class="ts-gallery__image">
                                <div class="ts-gallery__item-description">
                                    <h6 class="ts-opacity__50">طراحی وب</h6>
                                    <h4>لورم ایپسوم</h4>
                                </div>
                        ...
                        <a href="assets/img/img-work-03.png" class="card ts-gallery__item popup-image" data-animate="ts-fadeInUp">
                            <div class="ts-gallery__image">
                                ...
                                <div class="ts-gallery__item-description">
                                    <h6 class="ts-opacity__50">تایپوگرافی</h6>
                                    <h4>لورم</h4>
                                </div>
                                <!--end ts-gallery__item-description-->
                            </div>
                        ...
                        <a href="assets/img/img-work-04.png" class="card ts-gallery__item popup-image" data-animate="ts-fadeInUp">
                            <div class="ts-gallery__image">
                                ...
                                <div class="ts-gallery__item-description">
                                    <h6 class="ts-opacity__50">معرفی</h6>
                                    <h4>لورم ایپسوم</h4>
                                </div>
                                <!--end ts-gallery__item-description-->
                            </div>
                        ...
                        <!-- <a href="assets/img/img-work-05.png" class="card ts-gallery__item popup-image" data-animate="ts-fadeInUp">
                            <div class="ts-gallery__image">
                                ...
                                <div class="ts-gallery__item-description">
                                    <h6 class="ts-opacity__50">کد نویسی</h6>
                                    <h4>لورم ایپسوم</h4>
                                </div>
                                <!--end ts-gallery__item-description-->
                            </div>
                        ...
                        <!-- <a href="assets/img/img-work-07.png" class="card ts-gallery__item popup-image" data-animate="ts-fadeInUp">
                            <div class="ts-gallery__image">
                                ...
                                <div class="ts-gallery__item-description">
                                    <h6 class="ts-opacity__50">تجربه</h6>
                                    <h4>لورم ایپسوم</h4>
                                </div>
                                <!--end ts-gallery__item-description-->
                            </div>
                        ...
                        <!-- <a href="assets/img/img-work-08.png" class="card ts-gallery__item popup-image" data-animate="ts-fadeInUp">
                            <div class="ts-gallery__image">
                                ...
                                <div class="ts-gallery__item-description">
                                    <h6 class="ts-opacity__50">طراحی محصول</h6>
                        ...
                        <!-- <a href="assets/img/img-work-10.png" class="card ts-gallery__item popup-image" data-animate="ts-fadeInUp">
                            <div class="ts-gallery__image">
                                ...
                                <div class="ts-gallery__item-description">
                                    <h6 class="ts-opacity__50">توسعه برنامه</h6>
                                    <h4>لورم ایپسوم</h4>
                                </div>
                                <!--end ts-gallery__item-description-->
                            </div>
                        ...
                        <!-- <a href="assets/img/img-work-11.png" class="card ts-gallery__item popup-image" data-animate="ts-fadeInUp">
                            <div class="ts-gallery__image">
                                ...
                                <div class="ts-gallery__item-description">
                                    <h6 class="ts-opacity__50">هنر سه بعدی</h6>
                                    <h4>لورم ایپسوم</h4>
                                </div>
                                <!--end ts-gallery__item-description-->
                            </div>
                        ...
                        <!-- <a href="assets/img/img-work-09.png" class="card ts-gallery__item popup-image" data-animate="ts-fadeInUp">
                            <div class="ts-gallery__image">
                                ...
                                <div class="ts-gallery__item-description">
                                    <h6 class="ts-opacity__50">برندسازی</h6>
                                    <h4>لورم ایپسوم</h4>
                                </div>
                                <!--end ts-gallery__item-description-->
                            </div>
            ...
            <section class="ts-block" data-bg-image="assets/img/bg-man-sitting.jpg">
                <div class="container ts-promo-numbers">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="ts-promo-number text-center">
                                <figure class="odometer" data-odometer-final="9">0</figure>
                                <h5>پروژه ها</h5>
                            </div>
                            <!--end ts-promo-number-->
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <div class="owl-carousel" data-owl-dots="1" data-owl-loop="1" data-owl-autoplay="1" data-animate="ts-fadeInUp">
                                <div class="slide mb-5">
                                    <figure class="d-inline-block p-3 ts-bg-primary text-white ts-has-talk-arrow">
                                        <i class="fa fa-quote-right"></i>
                                    </figure>
                                    <p class="ts-h5">
                                        مدرک تحصیلی کارشناسی فناوری اطلاعات، کارشناس شبکه، کارشناس ماشین های مجازی و لینوکس، طراح وب،کارشناس سوشیاال مدیا و سلفی برندینگ
                                    </p>
                                    <div class="ts-circle__lg mb-3" data-bg-image="assets/img/person.jpg"></div>
                                    <h5 class="primary-font">مهدی علیزاده </h5>
                                    <h6 class="ts-opacity__40 primary-font"></h6>شرکت EVENTIT</h6>
                                </div>
                                <!--end slide-->
                                <div class="slide mb-5">
                                    <figure class="d-inline-block p-3 ts-bg-primary text-white ts-has-talk-arrow">
                                    ...
                                    <p class="ts-h5">
                                        کارشناسی فناوری اطلاعات، برنامه نویس و طراح ماشین های صنعتی و مسلط به C# ، PHP
                                    </p>
                                    <div class="ts-circle__lg mb-3" data-bg-image="assets/img/person-02.jpg"></div>
                                    <h5 class="primary-font">محمد کاظم صالحی </h5>
                                    <h6 class="ts-opacity__40 primary-font">شرکت سامان کیش </h6>
                                </div>
                                <!--end slide-->
                            </div>
                            <!--end owl-carousel-->
        ...
        <footer id="ts-footer" class="mt-5">
            ...
            <section id="contact" class="ts-block ts-separate-bg-element" data-bg-image="assets/img/bg-man-wall.jpg" data-bg-image-opacity=".1">
                <div class="container">
                    <div class="ts-title text-center">
                        <h2 class="ts-bubble-border">در ارتباط باشید</h2>
                    </div>
                    <div class="row text-center ">
                        <div class="col-sm-6 col-md-3 mb-4" data-animate="ts-fadeInUp">
                            <img src="assets/img/icon-pin.png" class="mb-4" alt="">
                            <h5>آدرس</h5>
                            <div class="ts-opacity__50 line-height-2">
                                <figure class="mb-0">تهران</figure>
                                <figure> شرکت EVENTIT</figure>
                            </div>
                            <!--end ts-opacity__50-->
                        </div>
                        <!--end col-md-3-->
                        <div class="col-sm-6 col-md-3 mb-4" data-animate="ts-fadeInUp" data-delay=".1s">
                            ...
                            <h5>تلفن</h5>
                            <div class="ts-opacity__50 line-height-2">
                                <figure class="mb-0"><span class="ltr-text">+98 939 650 6246</span></figure>
                                <figure><span class="ltr-text">+98 922 761 2649</span></figure>
                            </div>
                            <!--end ts-opacity__50-->
                        </div>
                        <!--end col-md-3-->
                        <div class="col-sm-6 col-md-3 mb-4" data-animate="ts-fadeInUp" data-delay=".2s">
                            ...
                            <h5>ایمیل</h5>
                            <div class="ts-opacity__50 line-height-2">
                                <figure class="mb-0">EJafaary@gmail.com</figure>
                                <figure>support@EJafary.ir</figure>
                            </div>
                            <!--end ts-opacity__50-->
                        </div>
                        <!--end col-md-3-->
                        <div class="col-sm-6 col-md-3 mb-4" data-animate="ts-fadeInUp" data-delay=".3s">
                            ...
                            <h5>چت تلگرام</h5>
                            <div class="ts-opacity__50 line-height-2">
                                <figure><span class="ltr-text"> <a href="https://t.me/EJafary" target="blank">@EJafary  </a></span></figure>
                            </div>
                            <!--end ts-opacity__50-->
                        </div>
                        <!--end col-md-3-->
                    ...
                    <div class="pt-5">
                        <div class="row">
                            <div class="col-md-4">
                                <h3>بیایید متصل شویم</h3>
                                <div class="ts-column-count-sm-2">
                                    <!-- <a href="#" class="mb-3 text-white d-block">
                                    <span class="ts-circle__xs border border-white ts-border-light mr-4 align-middle">
                            ...
                            <div class="col-md-8 mt-5 mt-md-0">
                                <h3>یک پیام برایم بفرستید</h3>
                                <form id="form-contact" method="post" class="clearfix ts-form ts-form-email" data-php-path="assets/php/email.php">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <label for="form-contact-name">نام *</label>
                                                <input type="text" class="form-control" id="form-contact-name" name="name" placeholder="نام" required>
                                            </div>
                                            <!--end form-group -->
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <label for="form-contact-email">ایمیل *</label>
                                                <input type="email" class="form-control text-left" id="form-contact-email" name="email" placeholder="ایمیل" dir="ltr" required>
                                            </div>
                                            <!--end form-group -->
                                        </div>
                                        <!--end col-md-6 col-sm-6 -->
                                    ...
                                    <!--end row -->
                                    <div class="form-group">
                                        <label for="form-contact-subject">موضوع *</label>
                                        <input type="text" class="form-control" id="form-contact-subject" name="subject" placeholder="موضوع" required>
                                    </div>
                                    <!--end form-group -->
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="form-contact-message" rows="4" name="message" placeholder="پیام" required></textarea>
                                            </div>
                                            <!--end form-group -->
                                        </div>
                                        <!--end col-md-12 -->
                                    ...
                                    <div class="form-group clearfix">
                                        <button type="submit" class="btn btn-primary float-right ts-btn-arrow" id="form-contact-submit">ارسال پیام</button>
                                    </div>
                                    <!--end form-group -->
            ...
            <div class="text-dark bg-white">
                <div class="container py-3 position-relative">
                    <small>تمامی حقوق متعلق به <a href="" target="_blank"> اسماعیل جعفری می باشد </a></small>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content border-0 rounded-0">
                ...
                <div class="modal-body p-5">
                    <h5 class="mb-4">جدیدترین کار ها</h5>
                    <div class="owl-carousel" data-owl-dots="1" data-owl-loop="1" data-owl-autoplay="1">
                        <div class="slide">
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <h4 class="mb-3 mt-3 mt-md-0">نورهای خلاق</h4>
                                        <p>
                                        ...
                                        <a href="#" class="mb-4 text-dark d-block">
                                            <i class="fa fa-globe ts-opacity__50 mr-2 align-middle"></i>
                                            www.example.com
                                        </a>
                                        <hr>
                                        <h6>خدمات ارائه شده</h6>
                                        <ul class="list-unstyled ts-opacity__50 line-height-2">
                                            <li>طراحی</li>
                                            <li>کد نویسی</li>
                        ...
                        <div class="slide">
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <h4 class="mb-3 mt-3 mt-md-0">لورم ایپسوم متن</h4>
                                        <p>
